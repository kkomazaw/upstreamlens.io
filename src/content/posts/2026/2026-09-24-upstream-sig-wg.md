---
title: "Upstream Sig-wg - 2026-09-24"
description: "CNCF upstream activity from sig-wg"
pubDate: 2026-09-24
category: "Notes"
tags: ["upstream", "CNCF", "SIG", "meeting-notes", "sig-node", "sig-scheduling", "sig-api-machinery", "KEP", "proposal", "kubernetes"]
draft: false
---
...
KEP-5823: Update alpha milestone to v1.38

Update the target alpha release of Pod-level Checkpoint/Restore for v1.38.
to be consistent with the KEP metadata and reflect the planned release.

Signed-off-by: Radostin Stoyanov <rstoyanov@fedoraproject.org>

🔗 [Link](https://github.com/kubernetes/enhancements/commit/7672f60a388a323ee8ec8a2e02232b7eeefc7e57)
...
### KEP unknown: Merge pull request #6374 from bgee/prequeueing-hints-beta-1.38

KEP-6132: promote PreQueueingHint to...
...
### KEP unknown: KEP-5474: Declare CgroupOptions node support

Runtime API support alone does not establish whether a...
...
### KEP unknown: KEP-5474: Define CgroupOptions API behavior

Validate CgroupOptions through spec.os, following the o...
...
### KEP unknown: KEP-5474: Define the CRI mount-mode contract

A single capability bit for CgroupOptions would leave ...
...
### KEP unknown: Merge pull request #6397 from ameukam/modernize-kep-4443

KEP-4443: Modernize proposal and productio...

Kubernetes Enhancement Proposal update

🔗 [Link](https://github.com/kubernetes/enhancements/blob/master/keps/sig-apps/4443-configurable-pod-failure-policy-reasons/README.md)
...
### KEP unknown: Merge pull request #6364 from seans3/kep-4006-ga-1.38

KEP-4006: Transition from SPDY to WebSockets ...

Kubernetes Enhancement Proposal update

🔗 [Link](https://github.com/kubernetes/enhancements/blob/master/keps/sig-api-machinery/4006-transition-spdy-to-websockets/README.md)
...
### KEP unknown: Merge pull request #6146 from bitoku/kep-5825-beta

KEP-5825: update CRI List Streaming for beta gra...

Kubernetes Enhancement Proposal update

🔗 [Link](https://github.com/kubernetes/enhancements/blob/master/keps/sig-node/5825-cri-pagination/README.md)
...
### KEP unknown: Merge pull request #6389 from dgrisonnet/worktree-cri-stats-1.38

KEP-2371: update milestone (1.38)

Kubernetes Enhancement Proposal update

🔗 [Link](https://github.com/kubernetes/enhancements/blob/master/keps/sig-node/2371-cri-pod-container-stats/README.md)
...
### KEP unknown: kep-6089: promote Workload Aware Scheduling Controller APIs to Beta (#6342)
...
### KEP unknown: keps: update cri-stats milestone
...
### KEP unknown: Address review feedback on release signoff checklist
...
nodeapprovers: relax validation for tech leads

allow them to have the marker, and also allow the standza not
to have the marker if it includes a tech lead

Signed-off-by: Peter Hunt <pehunt@redhat.com>

🔗 [Link](https://github.com/kubernetes/enhancements/commit/90ffb9c4d191af6b08413a182f5a3115b7ab2730)
